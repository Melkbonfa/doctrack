...
Criamos o script `backup_doctrack.ps1` que realiza cópias rotativas do banco de dados na pasta `backups/` dentro do projeto, guardando os últimos 15 dias.
...
7. No campo **Adicionar argumentos (opcional):** digite:
   ```plaintext
   -ExecutionPolicy Bypass -File "C:\caminho\completo\do-projeto\backup_doctrack.ps1"
   ```
