...
new_html = """  <!-- OVERLAY DE CARREGAMENTO & CONTAINER DO RELATÓRIO PDF -->
  <div id="pdf-wrapper" style="position: fixed; inset: 0; background: rgba(15,15,40,0.98); z-index: 99999; display: none; overflow: auto; padding: 0; margin: 0;">
    ...
    <div id="pdf-report-container" style="width: 1123px; height: 794px; background: #0f0f28; color: #f1f5f9; font-family: 'Inter', sans-serif; padding: 30px 40px; box-sizing: border-box; position: absolute; top: 0; left: 0; overflow: hidden; margin: 0;">
