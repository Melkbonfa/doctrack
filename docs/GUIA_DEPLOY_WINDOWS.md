...
**O que é:** o script `scripts/deploy_windows.ps1` faz o trabalho repetitivo: cria o
...
Rode o script `scripts/gerar_backup.ps1` (ele cria um backup do banco em
...
| Fazer backup | `.\scripts\gerar_backup.ps1` |
